...
from datasets_pie import Dots, PieDataset
...
parser.add_argument("--dataset", default='pie_30_0_135', type=str, help="dataset name") # pie dataset
parser.add_argument(
...
def sample_data_dots(path, batch_size, image_size, args):
    imgs = []
    labels = []
    db_path = [os.path.join(path,'data/dots/', f'{args.n_dots}_dots')]
